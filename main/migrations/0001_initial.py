# Generated by Django 4.2.9 on 2024-07-23 17:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('in_reply_to_status_id_str', models.CharField(blank=True, max_length=255, null=True)),
                ('in_reply_to_user_id', models.BigIntegerField(blank=True, null=True)),
                ('in_reply_to_user_id_str', models.CharField(blank=True, max_length=255, null=True)),
                ...
                ('quoted_status_id_str', models.CharField(blank=True, max_length=255, null=True)),
                ('quoted_status', models.JSONField(blank=True, null=True)),
                ('display_text_range', models.CharField(blank=True, max_length=255, null=True)),
